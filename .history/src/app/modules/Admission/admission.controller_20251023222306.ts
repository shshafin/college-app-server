...
// GET all admissions
const getMyAdmissions = catchAsync(async (req: Request, res: Response) => {
...
const getAdmissionById = catchAsync(async (req: Request, res: Response) => {
...
// UPDATE admission
const updateAdmission = catchAsync(async (req: Request, res: Response) => {
  const admissionId = req.params.id;
  const payload: any = { ...req.body, userId: req.user._id };
