...
// SEARCH colleges by name const searchCollegesByNameController = catchAsync(async (req: Request, res: Response) => {
  const name = req.query.name as string;
  const colleges = await collegeService.searchCollegesByName(name);
